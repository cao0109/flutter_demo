...
const customcolor1 = Color(0xFF6B3709);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF6B3709),
  customcolor1: Color(0xFF944A00),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFFFDCC6),
  onCustomcolor1Container: Color(0xFF301400),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF6B3709),
  customcolor1: Color(0xFFFFB784),
  onCustomcolor1: Color(0xFF4F2500),
  customcolor1Container: Color(0xFF713700),
  onCustomcolor1Container: Color(0xFFFFDCC6),
);
